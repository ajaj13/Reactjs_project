  ...
  return (
    <div  className="w-full h-full flex flex-col items-center justify-center gap-x-1">
      ...
      <div className="w-[670px]">
        <button onClick={() => navigation(-1)} className="border-2 border-gray-300 py-1 px-4 rounded-md mt-2">Back</button>
      </div>
      <div className='max-w-[670px] w-11/12 mt-6 flex flex-col gap-y-8'>
        {loading ? (
          ...
          <div>
            ...
            <h2 className="my-8 font-bold text-4xl">Releated Blogs</h2>
